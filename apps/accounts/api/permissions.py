...
from accounts.api.utils import is_authenticated, has_group, is_superuser, check_owner, is_safe_method
...
class IsOwner(BasePermission):
    def has_object_permission(self, request, view, obj):
        return check_owner(request, obj)


class DoctorReadOnly(BasePermission):
    def has_object_permission(self, request, view, obj):
